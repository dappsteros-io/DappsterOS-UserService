...
const (
	userServiceConfigDirPath  = "/etc/dappsteros"
	userServiceConfigFilePath = "/etc/dappsteros/user-service.conf"
	userServiceName           = "dappsteros-user-service.service"
	userServiceNameShort      = "user-service"
)

//go:embedded ../../build/sysroot/etc/dappsteros/user-service.conf.sample
